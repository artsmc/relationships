...
module.exports = {
  ...
  entry: {
    styles: ['toastify-js/src/toastify.css','./app/client/public/assets/css/styles.js'], // Assuming styles.js imports all necessary CSS
    vendor: ['jquery', 'hammerjs', 'micromodal', 'toastify-js'],
    app: [
      './app/client/public/assets/js/clipboard.min.js',
      ...
      './app/client/public/assets/js/webflow.js',
    ],
  },
  output: {
